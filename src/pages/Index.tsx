  ...
  const testimonials = [
    {
      ...
      role: "Compradora",
      content:
        "Excelente atendimento! Encontrei minha casa dos sonhos com a ajuda da equipe profissional da Premium Imóveis.",
      rating: 5,
    },
    {
      name: "João Santos",
      role: "Vendedor",
      content:
        "Venderam meu apartamento em tempo recorde e pelo melhor preço do mercado. Recomendo a todos!",
      rating: 5,
    },
    {
      name: "Ana Costa",
      role: "Locatária",
      content:
        "Processo de locação super transparente e ágil. Equipe sempre disponível para esclarecer dúvidas.",
      rating: 5,
    },
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Encontre exatamente o que você procura entre nossa ampla variedade
              de propriedades
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Card
              className="text-center group hover:shadow-strong transition-all duration-300 bg-gradient-card border-0 animate-scale-in"
      ...
      <section className="py-20 bg-secondary/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 animate-fade-in">
            <h2 className="text-4xl font-bold text-foreground mb-4">
              Por Que Escolher a{" "}
              <span className="text-primary">Premium Imóveis</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="text-center p-8 bg-gradient-card shadow-soft hover:shadow-strong transition-all duration-300 border-0 animate-fade-in-up">
              ...
              <p className="text-muted-foreground">
                Todos os nossos processos são seguros e transparentes, com
                acompanhamento jurídico especializado.
              </p>
            </Card>

            <Card
              className="text-center p-8 bg-gradient-card shadow-soft hover:shadow-strong transition-all duration-300 border-0 animate-fade-in-up"
              style={{ animationDelay: "0.2s" }}
            >
              ...
              <p className="text-muted-foreground">
                Processos otimizados e equipe experiente para tornar sua
            ...
            >
              ...
              <p className="text-muted-foreground">
                Atendimento personalizado e comprometimento total com a
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card
                key={index}
                className="p-8 bg-gradient-card shadow-soft hover:shadow-strong transition-all duration-300 border-0 animate-scale-in"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto animate-fade-in">
            ...
            <p className="text-xl mb-8 opacity-90">
              Nossa equipe está pronta para te ajudar a encontrar o imóvel
              perfeito. Entre em contato e comece sua jornada hoje mesmo!
            </p>
